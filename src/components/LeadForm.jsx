...
const pessoasOptions = [
  { value: '',    label: 'Quantas pessoas?' },
  { value: '1',   label: '1 pessoa' },
  { value: '2-4', label: '2 a 4 pessoas' },
  { value: '5-9', label: '5 a 9 pessoas' },
  { value: '10-29', label: '10 a 29 pessoas' },
  { value: '30+', label: '30 ou mais pessoas' },
]

const EMPTY_FORM = { name: '', phone: '', city: '', planType: '', pessoas: '', tipoPessoa: '', message: '' }
  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-96 h-96 rounded-full bg-[#C9A84C]/8 blur-3xl" />
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className={`reveal ${visible ? 'visible' : ''}`}>
            <span className="inline-block text-[#E8C97A] font-body text-sm font-semibold uppercase tracking-widest mb-4">
              Cotação gratuita
            </span>
            ...
            <p className="text-white/60 font-body text-xl leading-relaxed mb-8">
              Preencha o formulário e um especialista entra em contato em até 1 hora —{' '}
              <span className="text-white font-semibold">rápido e sem burocracia.</span>
            </p>
            ...
            <ul className="space-y-4">
              {[
                ...
                '1.500+ especialistas prontos para atender em até 1h',
              ].map((item) => (
                <li key={item} className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-[#C9A84C]/25 border border-[#C9A84C]/50 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <CheckCircle size={12} className="text-[#E8C97A]" />
                  </div>
            ...
            {submitted ? (
              <div className="bg-white rounded-3xl p-10 text-center shadow-2xl">
                ...
                <button
                  ...
                  className="text-[#B8923A] font-body font-medium text-sm underline underline-offset-2"
                >
                  Preencher novamente
                </button>
              </div>
              ...
              >
                {/* Gold accent top bar */}
                <div className="h-1 w-16 rounded-full bg-gradient-to-r from-[#C9A84C] to-[#E8C97A] mb-6" />

                <h3 className="font-display text-3xl font-semibold text-navy-900 mb-6">
                ...
                <div className="space-y-4">
                  ...
                  {/* Linha com 2 colunas: nº pessoas + PF/PJ */}
                  <div className="grid grid-cols-2 gap-3">
                    <Field label="Nº de pessoas">
                      <div className="relative">
                        <select
                          value={form.pessoas}
                          onChange={handle('pessoas')}
                      ...
                      <div className="flex gap-2 h-[50px]">
                        {['Física', 'Jurídica'].map(tipo => (
                          <button
                            key={tipo}
                            type="button"
                            onClick={() => setForm(f => ({ ...f, tipoPessoa: tipo }))}
                            className={`flex-1 flex items-center justify-center gap-1.5 rounded-xl border-2 text-sm font-body font-medium transition-all duration-150 ${
                              form.tipoPessoa === tipo
                                ? 'border-[#C9A84C] bg-[#C9A84C]/10 text-[#B8923A]'
                  ...
                  <Field label="Observações (opcional)">
                    <textarea
                      ...
                      placeholder="Plano atual, médicos ou hospitais de preferência, dúvidas..."
                      rows={3}
                ...
                <button
                  type="submit"
                  className="whatsapp-btn mt-6 w-full flex items-center justify-center gap-3 bg-[#B8923A] hover:bg-[#C9A84C] text-white font-body font-semibold text-lg py-4 rounded-2xl transition-all duration-200 shadow-lg shadow-[#B8923A]/40 hover:-translate-y-0.5"
                >
