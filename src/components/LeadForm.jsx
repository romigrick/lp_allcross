      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className={`reveal ${visible ? 'visible' : ''}`}>
            <span className="inline-block text-[#C9A84C] font-body text-sm font-semibold uppercase tracking-widest mb-4">
              Cotação gratuita
            </span>
          ...
          <div className={`reveal reveal-delay-2 ${visible ? 'visible' : ''}`}>
            {submitted ? (
              ...
              >
                ...
                <button
                  type="submit"
                  className="whatsapp-btn mt-6 w-full flex items-center justify-center gap-3 bg-[#C9A84C] hover:bg-[#DDB96A] text-white font-body font-semibold text-lg py-4 rounded-2xl transition-all duration-200 shadow-lg shadow-[#C9A84C]/30 hover:-translate-y-0.5"
                >
