...
import LogoBranca from "/src/assets/logo_branca.png"
  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-16 -right-16 w-80 h-80 rounded-full bg-[#C9A84C]/8 blur-3xl" />
      ...
      <div className={`relative max-w-3xl mx-auto px-4 sm:px-6 text-center reveal ${visible ? 'visible' : ''}`}>
        <div className="w-16 h-16 rounded-3xl bg-[#C9A84C]/20 border border-[#C9A84C]/30 flex items-center justify-center mx-auto mb-8">
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-[#C9A84C]">
        ...
        <p className="text-white/60 font-body text-xl leading-relaxed mb-10 max-w-xl mx-auto">
          Processo rápido, sem burocracia e sem compromisso. Comparativo gratuito com os melhores planos para o seu perfil.
        </p>

        <button
          onClick={() => openConsultantWA()}
          className="inline-flex items-center justify-center gap-3 bg-[#C9A84C] hover:bg-[#DDB96A] text-white font-body font-bold text-xl px-10 py-5 rounded-2xl transition-all duration-300 shadow-2xl shadow-amber-600/40 hover:shadow-amber-400/60 hover:-translate-y-1 animate-pulse-gold"
        >
    ...
    <footer className="bg-navy-950 text-white/40 py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          <img
            src={LogoBranca}
            alt="Allcross Seguros e Planos de Saúde"
